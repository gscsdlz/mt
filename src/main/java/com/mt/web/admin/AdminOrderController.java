...
public class AdminOrderController {
    ...
    private String historyOrder(@RequestParam Map<String, Object> param, Model model) {
        ParamUtils p = new ParamUtils(param);
        int page = p.getInteger("page", 1);
        int size = p.getInteger("size", 15);
        List<Order> data = orderService.getHistoryOrder(page, size);
        model.addAttribute("data", data);
        model.addAttribute("menu", "his_order");
